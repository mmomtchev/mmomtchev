...
A hang-glider is an ultra-light unpowered aircraft that it is launched on foot. Launching requires some height difference, *the initial capital*, after which a skilled pilot will be able to exploit its surroundings to continue to soar. Towed launches, usually being towed by a small powered aircraft, are also possible but are much less common.
